...
Product photography added for the KhasCom catalogue. All files live in `public/images/`.

Most images are **public domain or CC0** and carry **no attribution obligation**. Three are
CC BY-SA and **must be credited** if they stay on the live site — the rows are marked below.

## No attribution required (Public domain / CC0)

| File | Used for | Licence | Source |
|---|---|---|---|
| `tinda-apple-gourd.webp` | Tinda (Apple Gourd) | Public domain | [Desi Tinda.JPG](https://commons.wikimedia.org/wiki/File:Desi_Tinda.JPG) — Miansari66 |
| `loki-bottle-gourd.webp` | Loki (Bottle Gourd) | CC0 | [Lauki.JPG](https://commons.wikimedia.org/wiki/File:Lauki.JPG) — Miansari66 |
...
## Attribution required — credit these or replace them
...
Everything else in `public/images/` (the `unsplash-*` files, `pink-salt-real.webp`,
`premium_*.png`, `frozen_whole_chicken.png`, the `*.jpg` dry-fruit shots, `flags/`) came with
the original site and is unchanged. Their licensing was not re-verified as part of the rebrand.
